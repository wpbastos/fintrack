 ...
 *
 * Primary format: ISO (YYYY-MM-DD) - expected from AI-processed imports
 * Fallback: Text formats with month names (unambiguous)
 */
 ...
 * - YYYY-MM-DD, YYYY/MM/DD (ISO format - primary)
 ...
 */
export function resolveDate(rawDate: string): Date | null {
  if (!rawDate || typeof rawDate !== 'string') return null;

  const cleaned = rawDate.trim();
  if (!cleaned) return null;

  // Try ISO format first: YYYY-MM-DD or YYYY/MM/DD (expected from AI)
  ...
  // Fallback: "Jan 15, 2024" or "January 15, 2024"
  ...
  // Fallback: "15 Jan 2024" or "15 January 2024"
  ...
  // Fallback: "15-Jan-24" or "15-Jan-2024"
